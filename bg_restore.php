...
<?php
define('SG_ACTION_ID', '2');
define('SG_PLUGIN_NAME', 'backup');
define('SG_ENV_DB_PREFIX', 'wp_');
define('SG_SITE_URL', 'http://wordpress');
define('SG_BACKUP_SITE_URL', 'https://www.jetbackup.com/jetbackup-for-wordpress');
define('SG_PUBLIC_URL', 'http://wordpress/wp-content/plugins/backup/public/');
define('SG_BACKUP_DIRECTORY', 'W:\domains\wordpress/wp-content/uploads/jetbackup/');
define('SG_BACKUP_OLD_DIRECTORY', 'W:\domains\wordpress/wp-content/uploads/backup-guard/');
define('SG_BACKUP_GUARD_VERSION', '2.0.3');
define('SG_HOME_URL', 'http://wordpress');
define('SG_UPLOAD_PATH', 'W:\domains\wordpress/wp-content/uploads');
define('SG_SITE_TYPE', 'standard');
define('SG_ENV_VERSION', '6.1.1');
define('SG_PING_FILE_PATH', 'W:\domains\wordpress/wp-content/uploads/jetbackup/ping.json');
define('BG_PLUGIN_URL', 'http://wordpress/wp-admin/admin.php?page=backup_guard_backups');
define('BG_RESTORE_KEY', '80b8160ec75152b2d04a4d83b36893d1');
define('BG_RESTORE_URL', 'http://wordpress/bg_restore.php?k=80b8160ec75152b2d04a4d83b36893d1');
define('BG_AWAKE_URL', 'http://wordpress/wp-admin/admin-ajax.php?action=backup_guard_awake');
define('BG_IS_MULTISITE', '');
define('SG_MISC_MIGRATABLE_TABLES', 'wp_options,wp_usermeta');
define('SG_MULTISITE_TABLES_TO_MIGRATE', 'wp_blogs,wp_site');
define('SG_DB_NAME', 'wordpress');
define('DOMAIN_CURRENT_SITE', '');
define('PATH_CURRENT_SITE', '');
define('SG_SUBDOMAIN_INSTALL', '');
define('WP_CONTENT_DIR', 'W:\domains\wordpress/wp-content');
define('SG_BACKUP_DATABASE_EXCLUDE', 'wp_sg_action,wp_sg_config,wp_sg_schedule');
define('SG_MYSQL_VERSION', '8.0.19');
...
define('ABSPATH', 'W:\domains\wordpress/');
