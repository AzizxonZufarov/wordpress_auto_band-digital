...
<!--        </div>-->
      ...
      <div class="col-lg-2 col-md-4 col-6">
        ...
        'menu_class' => '',
        'echo'      => true,
        'items_wrap'=> '<h4>Сcылки</h4> <ul id="%1$s" class="%2$s">%3$s</ul>',
        'depth'=> 2,
        ]) ?>
      </div>
    ...
    <div class="row">
      <div class="col-lg-12 text-center">
        <div class="footer-copy">
          Copyright &copy; <?php echo date('Y'); echo " " . bloginfo('name');?>, Designed &amp; Developed by <a href="https://themefisher.com/">Themefisher</a>
        </div>
      </div>
    </div>
  </div>
